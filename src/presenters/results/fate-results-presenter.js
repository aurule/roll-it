 ...
 */
export function present({ rolls, locale = "en-US", ...rollOptions } = {}) {
 ...
 * @return {String}                           String describing the roll results
 */
export function presentMany({ description, raw, summed, modifier = 0, t } = {}) {
  const t_args = {
    description,
    count: raw.length,
    results: raw
 ...
 */
export function detail(raw, modifier = 0) {
