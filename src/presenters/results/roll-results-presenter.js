 ...
 * @return {String}                         String describing the roll results
 */
export function presentOne({ pool, sides, description, raw, summed, modifier = 0, t } = {}) {
  const t_args = {
 ...
 * @return {String}                         String describing the roll results
 */
export function presentMany({ pool, sides, description, raw, summed, modifier = 0, t } = {}) {
  const t_args = {
    count: raw.length,
    description,
    results: raw
 ...
 */
export function detail({ pool, sides, raw, modifier }) {
