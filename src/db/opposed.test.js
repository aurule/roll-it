...
describe("Opposed DB", () => {
  ...
  describe("challenge functions", () => {
    ...
    describe("findChallengeByMessage", () => {
      ...
      it("gets the associated challenge record", () => {
        const result = opposed.findChallengeByMessage(message_uid)
  ...
  describe("opposed test functions", () => {
    let challenge_id
    let attacker_id
    let defender_id
    const attacker_uid = "atk"
