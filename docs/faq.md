...
1. Look through the [generic rollers](/systems/generic). They roll plain dice and can probably accomplish what you need, albeit without any fancy automation.
...
* `/d10` - Roll some ten-sided dice
* `/d12` - Roll some twelve-sided dice
