...
This Terms of Service Agreement (the "Agreement") is entered into between Paige Andrews ("Bot Owner") and the user ("User") of the Roll It Discord bot (the "Bot").
...
5. Intellectual Property: The Bot and all intellectual property rights therein are and shall remain the property of the Bot Owner. The User agrees not to copy, modify, or distribute the Bot or any portion thereof except as granted by the MIT License, [reproduced on the website](/license).
...
8. Governing Law: This Agreement shall be governed by and construed in accordance with the laws of the United States of America and the State of New York as an agreement wholly performed in the State of New York without regard to their conflict of law provisions and the United Nations Conventions on Contracts (if applicable). Any dispute arising under or in connection with this Agreement shall first be subject to resolution through good-faith informal negotiation.
