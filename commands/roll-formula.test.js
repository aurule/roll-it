...
describe("data", () => {
  ...
  it("returns something", () => {
    const command_data = roll_formula_command.data()
  ...
  it("uses the command's name", () => {
    ...
    expect(command_data.name).toEqual(roll_formula_command.name)
  })
})

describe("help", () => {
  it("includes the command name in the output", () => {
    const help_text = roll_formula_command.help({ command_name: "sillyness" })
